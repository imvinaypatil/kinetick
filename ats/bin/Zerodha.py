...
from ats.shared.types.enums import InstrumentTypeEnum
...
class Zerodha():
    ...
    def get_order_variety(self, sec_type, pos_type):
        if sec_type == InstrumentTypeEnum.STOCK and pos_type == 'CO':
            return Zerodha.VARIETY_CO, Zerodha.PRODUCT_MIS
        if sec_type == InstrumentTypeEnum.STOCK and pos_type == 'MIS':
            return Zerodha.VARIETY_REGULAR, Zerodha.PRODUCT_MIS
        if sec_type == InstrumentTypeEnum.OPTION or sec_type == InstrumentTypeEnum.FUTURE:
            if pos_type == 'CO' or pos_type == 'MIS':
                return Zerodha.VARIETY_REGULAR, Zerodha.PRODUCT_MIS
